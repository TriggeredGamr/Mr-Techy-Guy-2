	...
	public static void main(String[] args){
		...
		double secondNumber = userInput.nextDouble();
			if (operation == 1) {
				...
				System.out.printf("Your answer is " + "%.2f" , sum);
			} else if (operation == 2) {
				double difference = firstNumber - secondNumber;
				System.out.printf("Your answer is " + "%.2f" , difference);
			} else if (operation == 3) {
				double product = firstNumber * secondNumber;
				System.out.printf("Your answer is " + "%.2f" , product);
			} else if (operation == 4) {
			...
			System.out.println("You didn't enter one of the listed numbers");
	}
}
}